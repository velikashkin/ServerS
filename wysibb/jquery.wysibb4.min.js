...
"undefined" == typeof WBBLANG && (WBBLANG = {}), WBBLANG.en = CURLANG = {
    ...
    a.wysibb = function (b, c) {
        ...
        this.options.themePrefix || a("link").each(a.proxy(function (b, c) {
                var d = a(c).get(0).href.match(/(.*\/)(.*)\/wbbtheme\.css.*$/);
                null !== d && (this.options.themeName = d[2], this.options.themePrefix = d[1])
            }, this)),
        "undefined" != typeof WBBPRESET && (WBBPRESET.allButtons && a.each(WBBPRESET.allButtons, a.proxy(function (a, b) {
                    b.transform && this.options.allButtons[a] && delete this.options.allButtons[a].transform
                }, this)), a.extend(!0, this.options, WBBPRESET)),
        c && c.allButtons && a.each(c.allButtons, a.proxy(function (a, b) {
                b.transform && this.options.allButtons[a] && delete this.options.allButtons[a].transform
            }, this)),
    ...
    a.wysibb.prototype = {
        ...
        init: function () {
            ...
            this.options.smileList && this.options.smileList.length > 0 && this.options.smileList.sort(function (a, b) {
            ...
            this.$txtArea.parents("form").find("input[id*='preview'],input[id*='submit'],input[class*='preview'],input[class*='submit'],input[name*='preview'],input[name*='submit']").bind("mousedown", a.proxy(function () {
                    this.sync(),
        ...
        initTransforms: function () {
                    ...
                    if (e.transform && e.skipRules !== !0) {
                        ...
                        for (var h in g) {
                            ...
                            if (e.bbSelector || (e.bbSelector = []), -1 == a.inArray(j, e.bbSelector) && e.bbSelector.push(j), this.options.onlyBBmode === !1) {
                                                    ...
                                                    if (g)
                                                        for (var h = 0; h < g.length; h++) {
                                                            ...
                                                            if (a.inArray(m, e) > -1 || a(d).parent().contents().size() > 1) {
                                                                ...
                                                                d.data = f.substr(0, f.indexOf(i) - 1),
                                                                a(d).after(this.elFromString(q, document)).after(n),
                                                                m = (m ? m + " " : "") + this.filterByNode(n),
                                                                k = !1
                                                            }
                                                            o[i.toLowerCase()] = {
                                                                sel: m,
                                ...
                                b.rules[l].push([j, o]),
                                e.onlyClearText === !0 && (this.cleartext || (this.cleartext = {}), this.cleartext[l] = c[d]),
                                e.groupkey && (b.groups[e.groupkey] || (b.groups[e.groupkey] = []), b.groups[e.groupkey].push(l))
                            }
                        }
            ...
            b.srules = {},
            this.options.smileList && a.each(b.smileList, a.proxy(function (c, d) {
            ...
            this.rsellist = [];
            for (var r in this.options.rules)
                this.rsellist.push(r);
        ...
        build: function () {
            if (a.log("Build editor"), this.$editor = a("<div>").addClass("wysibb"), this.isMobile && this.$editor.addClass("wysibb-mobile"), this.options.direction && this.$editor.css("direction", this.options.direction), this.$editor.insertAfter(this.txtArea).append(this.txtArea), this.startHeight = this.$txtArea.outerHeight(), this.$txtArea.addClass("wysibb-texarea"), this.buildToolbar(), this.$txtArea.wrap('<div class="wysibb-text">'), this.options.onlyBBmode === !1) {
                ...
                this.$body.bind("keydown", a.proxy(function (b) {
                        return 86 == b.which && (1 == b.ctrlKey || 1 == b.metaKey) || 45 == b.which && (1 == b.shiftKey || 1 == b.metaKey) ? (this.$pasteBlock || (this.saveRange(), this.$pasteBlock = a(this.elFromString('<div style="opacity:0;" contenteditable="true">﻿</div>')), this.$pasteBlock.appendTo(this.body), setTimeout(a.proxy(function () {
                                        ...
                                        this.body.focus(),
                                        this.cleartext && (a.log("Check if paste to clearText Block"), this.isInClearTextBlock() && (b = this.toBB(b).replace(/\n/g, "<br/>").replace(/\s{3}/g, '<span class="wbbtab"></span>'))),
                ...
                this.$body.bind("keydown", a.proxy(function (a) {
                        if (13 == a.which) {
                ...
                this.options.tabInsert === !0 && this.$body.bind("keydown", a.proxy(this.pressTab, this)),
                this.$body.bind("mouseup keyup", a.proxy(this.updateUI, this)),
                this.$body.bind("mousedown", a.proxy(function (a) {
                        this.clearLastRange(),
                        this.checkForLastBR(a.target)
                    }, this)),
                this.options.traceTextarea === !0 && (a(document).bind("mousedown", a.proxy(this.traceTextareaEvent, this)), this.$txtArea.val("")),
                this.options.hotkeys === !0 && this.$body.bind("keydown", a.proxy(this.presskey, this)),
                this.options.smileConversion === !0 && this.$body.bind("keyup", a.proxy(this.smileConversion, this)),
                this.inited = !0,
                this.options.autoresize === !0 && (this.$bresize = a(this.elFromString('<div class="bottom-resize-line"></div>')).appendTo(this.$editor).wdrag({
                        scope: this,
                        axisY: !0,
                        height: b
                    })),
            ...
            this.options.hotkeys === !0 && a(document).bind("keydown", a.proxy(this.presskey, this))
        },
        buildToolbar: function () {
            ...
            a.each(this.options.buttons, a.proxy(function (c, d) {
                    ...
                    (0 == c || "|" == d || "-" == d) && ("-" == d && this.$toolbar.append("<div>"), b = a('<div class="wysibb-toolbar-container">').appendTo(this.$toolbar)),
                    e && ("colorpicker" == e.type ? this.buildColorpicker(b, d, e) : "table" == e.type ? this.buildTablepicker(b, d, e) : "select" == e.type ? this.buildSelect(b, d, e) : "smilebox" == e.type ? this.buildSmilebox(b, d, e) : this.buildButton(b, d, e))
                }, this)),
            ...
            this.options.onlyBBmode === !1 && c.children(".wysibb-toolbar-btn").click(a.proxy(function (b) {
                    a(b.currentTarget).toggleClass("on"),
                    this.modeSwitch()
                }, this))
        },
        ...
        buildColorpicker: function (b, c, d) {
            ...
            for (var h = d.colors ? d.colors.split(",") : [], i = 0; i < h.length; i++)
                h[i] = a.trim(h[i]), g.append("-" == h[i] ? '<span class="pl"></span>' : this.strf('<div class="sc" style="background:{color}" title="{color}"></div>', {
                        color: h[i]
                    }));
            var j = a(document.body).css("color");
            this.controllers.push(e),
            e.bind("queryState", a.proxy(function () {
            ...
            e.mousedown(a.proxy(function (a) {
                    a.preventDefault(),
                    this.dropdownclick(".wbb-cp", ".wbb-list", a)
                }, this)),
            e.find(".sc").mousedown(a.proxy(function (b) {
                    b.preventDefault(),
            ...
            e.find(".nc").mousedown(a.proxy(function (a) {
                    a.preventDefault(),
                    this.selectLastRange(),
        ...
        buildSelect: function (b, c, d) {
            for (var e = a('<div class="wysibb-toolbar-btn wbb-select wbb-' + c + '">').appendTo(b).append(this.strf('<span class="val">{title}</span><ins class="fonticon sar"></ins>', d)).append(this.strf('<span class="btn-tooltip">{title}<ins/></span>', {
                ...
                if ("string" == typeof k) {
                    ...
                    a("<span>").addClass("option").attr("oid", c).attr("cmdvalue", k.exvalue).appendTo(f).append(this.strf(d.html, m)),
                    this.isMobile && i.append(a("<option>").attr("oid", c).attr("cmdvalue", k.exvalue).append(k.exvalue))
                }
            }
            ...
            e.bind("queryState", a.proxy(function () {
                    ...
                    e.find(".option").each(a.proxy(function (b, c) {
                            var d = a(c),
                            e = this.queryState(d.attr("oid"), !0),
                            f = d.attr("cmdvalue");
            ...
            e.find(".option").mousedown(a.proxy(function (b) {
                    b.preventDefault();
        ...
        buildSmilebox: function (b, c, d) {
            if (this.options.smileList && this.options.smileList.length > 0) {
                ...
                f.mousedown(a.proxy(function (a) {
                        a.preventDefault(),
                        this.dropdownclick(".wbb-smilebox", ".wbb-list", a)
                    }, this)),
                f.find(".smile").mousedown(a.proxy(function (b) {
                        b.preventDefault(),
                        this.insertAtCursor(this.options.bbmode ? this.toBB(a(b.currentTarget).html()) : a(a(b.currentTarget).html()))
                    }, this))
            }
        },
        updateUI: function (b) {
            ...
            if (!f || f == b) {
                if (d.excmd)
                    if (this.options.bbmode)
                        ...
                        this.execNativeCommand(d.excmd, c || !1);
                else
                    d.cmd ? d.cmd.call(this, b, c, e) : this.wbbExecCommand.call(this, b, c, e);
                this.updateUI()
            }
        },
        queryState: function (b, c) {
            ...
            if (c)
                try {
                    ...
                    return "foreColor" == d.excmd && (h = this.rgbToHex(h)),
                    h
                } catch (i) {
                    return !1
                }
        ...
        wbbExecCommand: function (b, c, d) {
            ...
            if (e)
                if (e.modal)
                    a.isFunction(e.modal) ? e.modal.call(this, b, e.modal, d) : this.showModal.call(this, b, e.modal, d);
                else if (d && 1 != e.subInsert)
            ...
            if (this.options.bbmode) {
                ...
                a.each(d.rootSelector, a.proxy(function (e, g) {
                        ...
                        if (i.is("span[wbb]") || !i.is("span,font")) {
                            if (c !== !0 && j && j.seltext)
                                if (j && j.seltext && j.seltext.sel) {
                                    ...
                                    d.onlyClearText === !0 && (k = this.getHTML(k, !0, !0), k = k.replace(/\&#123;/g, "{").replace(/\&#125;/g, "}")),
                                    i.replaceWith(k)
                                } else {
                                    var k = i.html();
                                    d.onlyClearText === !0 && (k = this.getHTML(k, !0), k = k.replace(/\&lt;/g, "<").replace(/\&gt;/g, ">").replace(/\&#123;/g, "{").replace(/\&#125;/g, "}")),
                                    i.replaceWith(k)
                                }
                            else
                                this.setCursorByEl(i), i.remove();
                            return !1
                        } {
                            var l = this.getRange(),
                        ...
                        if (window.getSelection) {
                            ...
                            o.moveToElementText(h), p.moveToElementText(h), o.setEndPoint("EndToStart", l), p.setEndPoint("StartToEnd", l);
                        ...
                        return c !== !0 && i.after(n),
                        window.getSelection ? (i.html(r), c !== !0 && this.selectNode(n)) : i.replaceWith(r),
                        !1
                    }, this))
            }
        },
        execNativeCommand: function (b, c) {
            if (this.body.focus(), "insertHTML" != b || window.getSelection)
                if ("insertHTML" == b) {
                    ...
                    "undefined" == typeof c && (c = !1), this.lastRange && (a.log("Last range select"), this.selectLastRange()), document.execCommand(b, !1, c);
            else {
                var g = this.lastRange ? this.lastRange : document.selection.createRange();
                g.pasteHTML(c);
                var h = a("<div>").html(c).text(),
                i = h.indexOf("﻿");
                i > -1 && (g.moveStart("character", -1 * (h.length - i)), g.select()),
                this.lastRange = !1
            }
        },
        ...
        getBBCodeByCommand: function (b, c) {
            ...
            d = d.replace(/\{(.*?)(\[.*?\])*\}/g, function (a, b, d) {
                if (d) {
                    var e;
                    if (d && (e = new RegExp(d + "+", "i")), "undefined" != typeof c[b.toLowerCase()] && null === c[b.toLowerCase()].toString().match(e))
                        return ""
                }
            ...
            if (this.options.allButtons[b].transform) {
                ...
                a.each(g, function (a, b) {
                    ...
                    b = b.replace(/\{(.*?)(\[.*?\])*\}/g, function (a, b, e) {
                        ...
                        e && (f = new RegExp(e + "+", "i")),
                        ("undefined" == typeof c[b.toLowerCase()] || e && null === c[b.toLowerCase()].toString().match(f)) && (d = !1),
        ...
        getHTMLByCommand: function (b, c) {
            ...
            c = this.keysToLower(c),
            "undefined" == typeof c && (c = {}),
            c.seltext || (c.seltext = this.getSelectText(!1), "" == c.seltext ? c.seltext = "﻿" : (c.seltext = this.clearFromSubInsert(c.seltext, b), this.options.allButtons[b].onlyClearText === !0 && (c.seltext = this.toBB(c.seltext).replace(/\</g, "&lt;").replace(/\n/g, "<br/>").replace(/\s{3}/g, '<span class="wbbtab"></span>'))));
            var d = "";
            this.seltextID = "wbbid_" + ++this.lastid,
            "link" != b && "img" != b ? c.seltext = '<span id="' + this.seltextID + '">' + c.seltext + "</span>" : d = '<span id="' + this.seltextID + '">﻿</span>';
            var e = this.options.allButtons[b].html;
            e = e.replace(/\{(.*?)(\[.*?\])*\}/g, function (a, b, d) {
                if (d) {
                    var e = new RegExp(d + "+", "i");
                    if ("undefined" != typeof c[b.toLowerCase()] && null === c[b.toLowerCase()].toString().match(e))
                        return ""
                }
                return "undefined" == typeof c[b.toLowerCase()] ? "" : c[b.toLowerCase()]
            });
            ...
            if (this.options.allButtons[b].transform) {
                ...
                a.each(h, function (a, b) {
                    ...
                    b = b.replace(/\{(.*?)(\[.*?\])*\}/g, function (a, b, f) {
                        ...
                        return b = b.toLowerCase(),
                        f && (g = new RegExp(f + "+", "i")),
                        ("undefined" == typeof c[b] || f && null === c[b].toString().match(g)) && (d = !1),
        ...
        getRange: function () {
            ...
            if (a.getRangeAt && a.rangeCount > 0)
                return a.getRangeAt(0);
            if (a.anchorNode) {
                var b = (this.options.bbmode, document.createRange());
                return b.setStart(a.anchorNode, a.anchorOffset),
        ...
        insertAtCursor: function (b, c) {
            if ("string" != typeof b && (b = a("<div>").append(b).html()), this.options.bbmode && "undefined" == typeof c || c === !0) {
                ...
                document.selection ? (this.txtArea.focus(), this.getSelection().text = b) : (this.txtArea.selectionStart || "0" == this.txtArea.selectionStart) && (this.txtArea.value = this.txtArea.value.substring(0, this.txtArea.selectionStart) + b + this.txtArea.value.substring(this.txtArea.selectionEnd, this.txtArea.value.length)),
                0 > e && (e = 0),
        ...
        getSelectNode: function (b) {
            ...
            return a(c).is(".imgWrap") && (c = a(c).children("img")[0]),
            c
        },
        getCursorPosBB: function () {
            var a = 0;
            if ("selectionStart" in this.txtArea)
                a = this.txtArea.selectionStart;
            else {
                this.txtArea.focus();
                var b = this.getRange(),
        ...
        setCursorPosBB: function (a) {
            if (this.options.bbmode)
                if (window.getSelection)
                    this.txtArea.selectionStart = a, this.txtArea.selectionEnd = a;
                else {
        ...
        toBB: function (b) {
            ...
            c.is("div,blockquote,p") && 3 != c[0].nodeType && c[0].lastChild && "BR" == c[0].lastChild.tagName && a(c[0].lastChild).remove(),
            c.find("ul > br, table > br, tr > br").remove();
            var d = "";
            return a.each(this.options.srules, a.proxy(function (a, b) {
                    c.find(a).replaceWith(b[0])
                }, this)),
            c.contents().each(a.proxy(function (b, c) {
                    var e = a(c);
                    if (3 === c.nodeType)
                        d += c.data.replace(/\n+/, "").replace(/\t/g, "   ");
                    else {
                            ...
                            if (e && e.is(g))
                                for (var h = this.options.rules[g], b = 0; b < h.length; b++) {
                                    ...
                                    if (e.is("br") || (i = i.replace(/\n/g, "<br>")), i = i.replace(/\{(.*?)(\[.*?\])*\}/g, a.proxy(function (b, d) {
                                                    ...
                                                    if (f.attr && !g.attr(f.attr))
                                                        return k = !0, d;
                                                    var h = f.attr ? g.attr(f.attr) : g.html();
                                                    if ("undefined" == typeof h || null == h)
                                                        return k = !0, d;
                                                    var i = f.rgx;
                                                    i && "style" == f.attr && ";" != i.substr(i.length - 1, 1) && (i += ";"),
                                                    "style" == f.attr && h && ";" != h.substr(h.length - 1, 1) && (h += ";");
                                                    ...
                                                    if (f.attr && k === !1)
                                                        if ("style" == f.attr) {
                                                            ...
                                                            f.rgx === !1 && (l = !0, m = !0, g.removeAttr(f.attr));
                                                    return e.is("table,tr,td,font") && (l = !0),
                                                    h || ""
                                                }, this)), !k) {
                                        if (e.is("img,br,hr")) {
                                            d += i,
        ...
        getHTML: function (b, c, d) {
            if (!this.options.bbmode && !c)
                return this.$body.html();
            d || (b = b.replace(/</g, "&lt;").replace(/\{/g, "&#123;").replace(/\}/g, "&#125;")),
            b = b.replace(/\[code\]([\s\S]*?)\[\/code\]/g, function (a) {
                return a = a.substr("[code]".length, a.length - "[code]".length - "[/code]".length).replace(/\[/g, "&#91;").replace(/\]/g, "&#93;"),
                "[code]" + a + "[/code]"
            }),
            a.each(this.options.btnlist, a.proxy(function (c, d) {
                    if ("|" != d && "-" != d) {
                        if (!this.options.allButtons[d] || !this.options.allButtons[d].transform)
                            return !0;
                        a.each(this.options.allButtons[d].transform, a.proxy(function (c, d) {
                                c = c.replace(/\n/g, "");
                                var e = [];
                                d = d.replace(/(\(|\)|\[|\]|\.|\*|\?|\:|\\|\\)/g, "\\$1"),
                                d = d.replace(/\{(.*?)(\\\[.*?\\\])*\}/gi, a.proxy(function (a, b, c) {
                                            return e.push(b),
                                            c ? (c = c.replace(/\\/g, ""), "(" + c + "*?)") : "([\\s\\S]*?)"
                                        }, this));
        ...
        smileRPL: function (b, c) {
            ...
            a.each(this.options.smileList, a.proxy(function (b, e) {
                    ...
                    if (-1 != f) {
                        ...
                        return c.data = d = c.data.substr(0, f),
        ...
        strf: function (b, c) {
            return c = this.keysToLower(a.extend({}, c)),
        ...
        elFromString: function (b) {
            if (-1 != b.indexOf("<") && -1 != b.indexOf(">")) {
                ...
                return a(c).html(b),
                this.setUID(c, "wbb"),
                a(c).contents().size() > 1 ? c : c.firstChild
            }
        ...
        splitPrevNext: function (b) {
            ...
            a(b.previousSibling).is(c) && (a(b).prepend(a(b.previousSibling).html()), a(b.previousSibling).remove())
        },
        modeSwitch: function () {
        ...
        clearPaste: function (b) {
            ...
            c.find("*[wbbkeep!='1']").each(a.proxy(function (b, c) {
                    var d = a(c);
        ...
        traceTextareaEvent: function (b) {
            0 == a(b.target).closest("div.wysibb").size() && (a(document.activeElement).is("div.wysibb-body") && this.saveRange(), setTimeout(a.proxy(function () {
                        ...
                        this.options.bbmode !== !1 || "" == c || 0 != a(b.target).closest("div.wysibb").size() || this.$txtArea.attr("wbbsync") || (this.selectLastRange(), this.insertAtCursor(this.getHTML(c, !0)), this.$txtArea.val("")),
                ...
                if (3 == b.nodeType) {
                    ...
                    c.length >= 2 && !this.isInClearTextBlock(b) && 0 == a(b).parents("a").size() && a.each(this.options.srules, a.proxy(function (d, e) {
                            ...
                            if (-1 != g) {
                                ...
                                return b.data = b.data.substr(0, g),
        ...
        imgEventHandler: function (b) {
            ...
            c.is("img") && c.closest(".wysibb-body").size() > 0 && (c.wrap("<span class='imgWrap'></span>"), this.hasWrapedImage = c, this.$body.focus(), this.selectNode(c.parent()[0]))
        },
        showModal: function (b, c, d) {
            ...
            if (this.$modal.find("span.wbbm-title-text").html(c.title), c.tabs && c.tabs.length > 1) {
                ...
                a.each(c.tabs, a.proxy(function (a, b) {
                        0 == a && (b.on = "on"),
                        g.append(this.strf("<li class=\"{on}\" onClick=\"$(this).parent().find('.on').removeClass('on');$(this).addClass('on');$(this).parents('.wbbm-content').find('.tab-cont').hide();$(this).parents('.wbbm-content').find('.tab" + a + "').show()\">{title}</li>", b))
                    }, this))
            }
            c.width && f.css("width", c.width);
            var h = a('<div class="wbbm-cont">').appendTo(e);
            d ? f.find("#wbbm-remove").show() : f.find("#wbbm-remove").hide(),
            a.each(c.tabs, a.proxy(function (b, c) {
                    var e = a("<div>").addClass("tab-cont tab" + b).attr("tid", b).appendTo(h);
                    b > 0 && e.hide(),
                    c.html ? e.html(this.strf(c.html, this.options)) : a.each(c.input, a.proxy(function (b, c) {
                            c.value = d[c.param.toLowerCase()],
                            "seltext" != c.param.toLowerCase() || c.value && "" != c.value || (c.value = this.getSelectText(this.options.bbmode)),
                            c.value && 0 == c.value.indexOf("<span id='wbbid") && a(c.value).is("span[id*='wbbid']") && (c.value = a(c.value).html()),
                            e.append(c.type && "div" == c.type ? this.strf('<div class="wbbm-inp-row"><label>{title}</label><div class="inp-text div-modal-text" contenteditable="true" name="{param}">{value}</div></div>', c) : this.strf('<div class="wbbm-inp-row"><label>{title}</label><input class="inp-text modal-text" type="text" name="{param}" value="{value}"/></div>', c))
                        }, this))
                }, this)),
            a.isFunction(c.onLoad) && c.onLoad.call(this, b, c, d),
            f.find("#wbbm-submit").click(a.proxy(function () {
                    ...
                    a.each(this.$modal.find(".tab-cont:visible .inp-text"), a.proxy(function (b, d) {
                            ...
                            "undefined" != typeof j && (i.match(new RegExp(j, "i")) || (g = !1, a(d).after('<span class="wbbm-inperr">' + CURLANG.validation_err + "</span>").addClass("wbbm-brdred"))),
                            f[h] = i
                        }, this)),
                    g && (a.log("Last range: " + this.lastRange), this.selectLastRange(), d && this.wbbRemoveCallback(b, !0), this.wbbInsertCallback(b, f), this.closeModal(), this.updateUI())
                }, this)),
            f.find("#wbbm-remove").click(a.proxy(function () {
                    this.selectLastRange(),
                    this.wbbRemoveCallback(b),
                    this.closeModal(),
                    this.updateUI()
            ...
            this.$modal.show(),
            this.isMobile ? f.css("margin-top", "10px") : f.css("margin-top", (a(window).height() - f.outerHeight()) / 3 + "px"),
            setTimeout(a.proxy(function () {
        ...
        closeModal: function () {
            return a(document.body).css("overflow", "auto").css("padding-right", "0").unbind("keyup", this.escModal),
        ...
        debug: function (b) {
            if (this.options.debug === !0) {
                ...
                "undefined" != typeof console ? console.log(c - this.startTime + " ms: " + b) : a("#exlog").append("<p>" + (c - this.startTime) + " ms: " + b + "</p>"),
                this.startTime = c
            }
        },
        isChrome: function () {
    ...
    a.fn.wdrag = function (b) {
        ...
        b.scope.drag_mousedown = function (e) {
            ...
            c = !0,
            a(document).bind("mousemove", a.proxy(b.scope.drag_mousemove, this)),
    ...
    a.fn.insertAtCursor = function (a, b) {
        return this.data("wbb").insertAtCursor(a, b),
        this.data("wbb")
    },
    a.fn.execCommand = function (a, b) {
        return this.data("wbb").execCommand(a, b),
        this.data("wbb")
    },
    a.fn.insertImage = function (a, b) {
        ...
        return this.insertAtCursor(d),
        c
    },
    a.fn.sync = function () {
        return this.data("wbb").sync(),
        this.data("wbb")
    },
        ...
        init: function () {
            if (null != window.FormData) {
                ...
                this.$block.bind("dragover", function () {
                    return a(this).addClass("dragover"),
                    !1
                }),
                this.$block.bind("dragleave", function () {
                    return a(this).removeClass("dragover"),
                    !1
                });
                ...
                this.$block[0].ondrop = a.proxy(function (b) {
                    ...
                    this.opt.extraParams && a.each(this.opt.extraParams, function (a, b) {
                        e.append(a, b)
                    }),
                    this.$loader = a('<div class="loader"><img src="' + this.opt.themePrefix + "/" + this.opt.themeName + '/img/loader.gif" /><br/><span>' + CURLANG.loading + "</span></div>"),
